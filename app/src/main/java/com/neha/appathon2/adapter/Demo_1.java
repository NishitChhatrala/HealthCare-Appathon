...
public class Demo_1 extends RecyclerView.Adapter<Demo_1.ViewHolder> {
    ...
    public Demo_1(Context context) {
        super();

        this.context = context;
        mItems = new ArrayList<NatureItem>();
        NatureItem nature = new NatureItem();
        nature.setName("Dr 11");

        mItems.add(nature);

        nature = new NatureItem();
        nature.setName("Dr 22");
        mItems.add(nature);

        nature = new NatureItem();
        nature.setName("Dr 33");
        mItems.add(nature);
